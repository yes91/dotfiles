;;; cyber-theme.el --- an Emacs 24 theme based on a terribly misinformed idea of what programmers do.

(deftheme cyber
  "cyber theme - an Emacs 24 theme based on a terribly misinformed idea of what programmers do.")
...
(custom-theme-set-faces
 'cyber
 '(cursor                              ((t (                       :background "#00CCCC"                                                ))))
 '(default
   (
    (((class color) (min-colors 16777216)) (:foreground "#BEDDDC" :background "#171518"))
 ...
 '(region                              ((t (:foreground "#171518"  :background "#BEDDDC"                                               ))))
 ...
 '(font-lock-constant-face             ((t (:foreground "#CFC5FF"  :background nil                                                     ))))
 `(font-lock-doc-string-face           ((t (:foreground "#DFD3E9"  :background nil                                                     ))))
 '(font-lock-function-name-face        ((t (:foreground "#51cfaf"  :background nil                                                     ))))
 '(font-lock-keyword-face              ((t (:foreground "#C2C219"  :background nil                                                     ))))
 '(font-lock-negation-char-face        ((t (:foreground "#C75311"  :background nil                                                     ))))
 '(font-lock-string-face               ((t (:foreground "#94D4D9"  :background nil                                                     ))))
 '(font-lock-variable-name-face        ((t (:foreground "#cle   "  :background nil                                                     ))))
